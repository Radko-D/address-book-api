...
export class CustomFieldService {
  ...
  async createCustomField(customField: CreateCustomField, recordId: string, userId: string): Promise<CustomField> {
    try {
  ...
  async updateCustomField(fieldId: string, userId: string, customField: Partial<CustomField>): Promise<void> {
